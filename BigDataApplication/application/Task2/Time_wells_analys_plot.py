...
class Plotter:
    ...
    def plot_scatter(self, alpha=0.6, figsize=(20, 8)):
        ...
        ax.plot(self.dates[11:], self.avgtime_prod, color = 'navy',linewidth=2, label='moving averge time_prod')
        ax.plot(self.dates[11:], self.avgtime_inj, color = 'firebrick',linewidth=2, label ='moving averge time_inj')
...
def main_plot(field_value):
    ...
    try:
        ...
        try:
            ...
            print(f'График сохранен в /output/{field_name}_time_well_analys.png')
        except:
