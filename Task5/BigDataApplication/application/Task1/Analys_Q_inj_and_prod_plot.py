...
class Plotter:
    ...
    def plot_scatter(self, alpha=0.6, figsize=(20, 8)):
        ...
        ax.plot(self.dates[11:], self.avg_sum_q_prod, color = 'navy',linewidth=2, label ='moving averge q_prod')
        ax.plot(self.dates[11:], self.avg_sum_q_inj, color = 'green',linewidth=2, label='moving averge q_inj')
...
def main_plot(field_value):
    ...
    #print(data)
        ...
        try:
            ...
            print(f'График сохранен в /output/{field_name}_q_prod_and_q_inj.png' )
        except:
