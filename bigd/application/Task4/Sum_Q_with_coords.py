...
def main():
    ...
    query_create_table = read_sql_file('/app/Task4/create_result_table_q_with_coords.sql')
    query_insert_data = read_sql_file('/app/Task4/insert_into_result_table_q_with_coords.sql')
